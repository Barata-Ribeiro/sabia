            ...
            <div className="mx-auto flex size-fit flex-col items-start justify-between gap-8 rounded-lg border border-background-900 bg-white p-4 font-body">
                ...
                <article className="flex w-full flex-col items-center justify-center gap-4">
                    ...
                    <p className="max-w-[80ch] text-pretty leading-6">
                        Per our terms of service, when you delete your account, all your data will be permanently
                        erased, and there will be no way to recover it. This action is irreversible and final. The
                        reason for complete data deletion is to ensure the privacy and security of your account and our
                        platform. If you are sure you want to delete your account, type your username below followed by
                        the word &rdquo;<strong>-DELETE</strong>&ldquo; to confirm.
                    </p>
                    <DeleteAccountForm />
                </article>
            </div>
