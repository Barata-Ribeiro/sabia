...
export default function NewPostFeedForm() {
    ...
    const { isPending, formState, formAction, onSubmit } = useForm(postNewPost, {
        ok: false,
        clientError: null,
        response: null
    })
    ...
    return (
        <div className="mt-2 w-full">
            <form action={formAction} onSubmit={onSubmit} className="">
                ...
                <div className="mt-2 flex justify-between">
                    ...
                    >
                        {isPending ? t("NewPostButtonLoading") : t("NewPostButtonSubmit")}
                    </Button>
                </div>
            </form>
        </div>
